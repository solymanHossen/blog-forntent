...
export function ThreeDCardDemo( {post,key}:any) {
    const {title,content,author,likes,updatedAt, createdAt,_id }=post
    console.log(_id,'this is the post')
    return (
        <CardContainer className="inter-var" >
            <CardBody
                ...
                <CardItem
                    as="p"
                    translateZ="60"
                    className="text-neutral-500 text-sm max-w-sm mt-2 dark:text-neutral-300 max-h-[100px] overflow-auto"
                >
                    {content}
                </CardItem>
                ...
                <div className="flex justify-between items-center mt-8">
                    ...
                    <div>Update at: {new Date(updatedAt).toLocaleDateString()}</div>
                </div>
